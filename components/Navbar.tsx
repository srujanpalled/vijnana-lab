...
const TITLES = [
  { text: "Vijnana Lab", lang: "en", sub: "Experience Science" },
  { text: "विज्ञान लैब", lang: "hi", sub: "विज्ञान का अनुभव करें" },
  { text: "ವಿಜ್ಞಾನ ಲ್ಯಾಬ್", lang: "kn", sub: "ವಿಜ್ಞಾನವನ್ನು ಅನುಭವಿಸಿ" }
];
